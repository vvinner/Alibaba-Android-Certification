...
import com.porster.gift.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.porster.gift.widget.pulltorefresh.internal.LoadingLayout;
import com.porster.gift.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.porster.gift.widget.pulltorefresh.internal.Utils;
import com.porster.gift.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		if (mMode.showFooterLoadingLayout()) {//TODO
	...
	final int gifCount=33;
	private void custemAnimator(int value){
		int offsetY=(Math.abs(value))/spacing;
		if(offsetY>=gifCount){
			offsetY=gifCount;
		}
		String imgName="refresh_"+offsetY;
	...
	private void init(Context context, AttributeSet attrs) {
		...
		refreshView=mHeaderLayout.mHeaderImage;
	 ...
	 * @author Chris Banes
	 */
	public static abstract class OnLastItemVisibleListener {
	...
	public void setOnScrollChangedListener(OnScrollChangedListener onScrollListener) {
	 ...
	 * 下拉距离监听
	 * @author AlidaoX
	 * @version Feb 2, 2016 10:47:04 AM
	 */
	public interface OnScrollChangedListener{
		public void OnScroll(View v, int offsetY);
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				...
				if(onScrollListener!=null&&mState!= State.REFRESHING){
